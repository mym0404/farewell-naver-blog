...
const usage = () => `Usage:
  ...
  bun .agents/skills/ingest-blog/scripts/collect-blog-errors.ts --blogId my-blog --reuseOutputDir /absolute/path/to/tmp/harness/ingest-blog/my-blog --rerunFailures
